  ...
  <x-auth-card>
    ...
    <form method="POST" action="{{ $url ?? route('login') }}">
      ...
      <div class="mt-4">
        ...
        <x-input id="password" type="password" name="password" value="" required autocomplete="current-password" />
      </div>
    ...
    <div>
      ...
      <select name="select"  id="SelectUser"  id="select" class="form-control selectpiker" onchange="getSelectedOption()">
          <option value="12345678,admin@pawlly.com" selected> Admin</option>
