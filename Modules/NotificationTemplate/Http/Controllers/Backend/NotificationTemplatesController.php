...
class NotificationTemplatesController extends Controller
{
    ...
    {
        $module_title = 'notification.title_template';
        $module_action = 'Edit';
        ...
        return view('notificationtemplate::backend.notificationtemplates.edit', compact('module_action', 'data', 'assets', 'buttonTypes','module_title'));
    }
