        ...
        <div class="row">
          <div class="col-12">
            <div class="form-group">
              ...
              <InputField type="password" class="col-md-12" :is-required="true" :label="$t('customer.lbl_password')"
                placeholder="" v-model="password" :error-message="errors['password']"
                :error-messages="errorMessages['password']"></InputField>

              <InputField type="password" class="col-md-12" :is-required="true" :label="$t('customer.lbl_confirm_password')"
